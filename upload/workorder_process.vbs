...
PDF_PATH = GetEnvVar("PDF_PATH")         ' e.g., "D:\auto\upload\pdfs\"
TARGET_URL = GetEnvVar("TARGET_URL")     ' e.g., "http://172.16.100.171:85/jde/E1Menu.maf"
UPLOAD_EXE_PATH = GetEnvVar("UPLOAD_EXE_PATH") ' e.g., "D:\auto\upload\Autoit\UploadFile.exe"
...
Sub ProcessWorkOrders()
    ...
    ' Process work orders
    Dim workOrders, wo
    workOrders = Array("609988","609989")
